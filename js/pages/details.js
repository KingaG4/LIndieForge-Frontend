        ...
        <div class="tab-content" id="gameDetailsTabsContent">
            ...
            <div class="tab-pane fade" id="kanban-pane" role="tabpanel" tabindex="0">
                <div class="row h-100" id="kanban-board">
                    <div class="col-md-3"><div class="card bg-dark border-secondary h-100"><div class="card-header border-secondary bg-secondary text-light fw-bold">To Do</div><div class="card-body p-2 kanban-column" id="kanban-todo" ondrop="drop(event, 'To Do')" ondragover="allowDrop(event)"></div></div></div>
